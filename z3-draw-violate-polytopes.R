...
# FTT
png("figure/z3-violate-two-level.png")
...
png("figure/z3-intersection-violate-two-level.png")
...
# TFT
png("figure/z3-violate-three-level.png")
...
png("figure/z3-intersection-violate-three-level.png")
...
do.polytope(c(switch.fnt(prob_TFT[5:8]),switch.fnt(prob_TFT[9:12])), simp, red="blue")
dev.off()
...
do.polytope.rgl(c(switch.fnt(prob_TFT[5:8]),switch.fnt(prob_TFT[9:12])), red="blue")
browseURL(paste("file://", writeWebGL(dir=file.path("figure/", "webGL"), width=700), sep=""))
